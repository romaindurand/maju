...
myPoll.vote({ Matrix: 5, Stargate: 1, Ghostbusters: 0, Terminator: 4 })
myPoll.vote({ Matrix: 1, Stargate: 3, Ghostbusters: 1, Terminator: 5 })
...
if (typeof document !== 'undefined') {
  ...
  const app = new App()
  app.update(myPoll.getScoreRatio().map(option => Object.assign({}, option, { height: 300, width: 20 })))
